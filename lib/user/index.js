...
class User
{
    ...
    constructor(user_id, info={}, bot)
    {
        ...
        this._bot._emmiter.on("message", (message, user, chat) =>
        {
            ...
            {
                this._emitter.emit("user_message", message, user, chat);
            }
        });
    ...
    send(message, options={})
    {
        ...
        this._bot._telegraf_bot.telegram.sendMessage(this._user_id, message.text, {
            reply_markup: {
    ...
    mute(chat)
    {
        ...
        this._bot._telegraf_bot.telegram.restrictChatMember(chat_id, this.user_id, {
            permissions: {
    ...
    kick(chat)
    {
        ...
        this._bot._telegraf_bot.telegram.kickChatMember(chat_id, this.user_id);
        return this;
    }
    /**
    ...
    ban(chat)
    {
        ...
        this._bot._telegraf_bot.telegram.banChatMember(chat_id, this.user_id);
        return this;
    }
    /**
    ...
    unban(chat)
    {
        ...
        this._bot._telegraf_bot.telegram.unbanChatMember(chat_id, this.user_id);
        return this;
    }
    /**
