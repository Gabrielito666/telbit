...
class Chat
{
    ...
    /**
     * @param {(message: import("../message/index"), user: import("../user/index"), chat: import("./index")) => void} callback
     * @returns {User}
    */
    onMessage(callback)
    {
    ...
    /**
     * @param {(user: import("../user/index"), chat: import("./index")) => void} callback
     * @returns {Chat}
    */
